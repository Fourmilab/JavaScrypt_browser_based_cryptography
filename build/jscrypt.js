    ...
    function setKey() {
        if (document.getElementById("key").keytype[0].checked) {
            var s = encode_utf8(document.getElementById("key").text.value);
            var i, kmd5e, kmd5o;
            ...
            var s = document.getElementById("key").text.value;
            ...
            if (hs.length > (keySizeInBits / 4)) {
                ...
                document.getElementById("key").text.value = hs = hs.slice(0, 64);
            } else {
    ...
    function Generate_key() {
        ...
        document.getElementById("key").text.value = k;
        prng = null;
    }
    ...
    function Encrypt_text() {
        ...
        if (document.getElementById("plain").text.value.length == 0) {
        ...
        var plaintext = encode_utf8(document.getElementById("plain").text.value);
        ...
        */
        ...
        if (document.getElementById("plain").encoding[0].checked) {
            v = armour_codegroup(ct);
        } else if (document.getElementById("plain").encoding[1].checked) {
            v = armour_hex(ct);
        } else if (document.getElementById("plain").encoding[2].checked) {
            v = armour_base64(ct);
        }
        document.getElementById("cipher").text.value = prefix + v + suffix;
        prng = null;
    }
    ...
    */
    ...
    function Decrypt_text() {
        ...
        if (document.getElementById("cipher").text.value.length == 0) {
        ...
        setKey();
        var ct = new Array(), kt;
        kt = determineArmourType(document.getElementById("cipher").text.value);
        if (kt == 0) {
            ct = disarm_codegroup(document.getElementById("cipher").text.value);
        } else if (kt == 1) {
            ct = disarm_hex(document.getElementById("cipher").text.value);
        } else if (kt == 2) {
            ct = disarm_base64(document.getElementById("cipher").text.value);
        }
        ...
        document.getElementById("plain").text.value = decode_utf8(plaintext);
    }
